        ...
        <div class="box">
            ...
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                <table align="center">
                    ...
                    <tr>
                        <td><label for="ps">nombre:</label></td>
                        <td><input type="text" name="nombre" id="ps" required></td>
                    </tr>
                    <tr>
                        <td><label for="ps">apellido:</label></td>
                        <td><input type="text" name="apellido" id="ps" required></td>
                    </tr>
                    <tr>
